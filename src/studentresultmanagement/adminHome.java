...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B. Tech", "M.Tech", "B. Arch" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "IEEE", "IT", "MECH" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        // save the items in database
        // we will store all the values we will get from form and store it in variable
        // and use them to put to database
        ...
        // try -catch block
        // connection with database can interupt anytime
        // to use "com.mysql.cj.jdbc.Driver" and other sql related classes, we will have to add mysql-connector-java.jar file we downloaded from internet
        ...
        try{
            ...
            Statement st = con.createStatement(); //st object help to create sql commands/statements //mysql works with statements only
            //things that we can do with execute-> update,add
            ...
            // show a message on successfull submission
            JOptionPane.showMessageDialog(null, "Data saved successfully");
            // we will close the jFrame and open a new adminHome jFrame
            setVisible(false);
            new adminHome().setVisible(true);
